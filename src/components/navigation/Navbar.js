    ...
    <>
      <nav className="nav">
        ...
        <ul className="nav__container">
          <li><a href="#about" className={screenSize >= 800 ? "nav__link" : "hidden"} 
            data-aos="fade-up" 
            data-aos-anchor-placement="top-top"
            data-aos-once="true"
            data-aos-offset="-200"
          ><span className="nav__number">01. </span>About me</a></li>
      ...
      <HamburgerNav screenSize={screenSize} sidebar={sidebar} showSidebar={showSidebar}/>
      <Sidebar sidebar={sidebar}>
        <ul className="nav__sidebar__container">
          <li><a href="#about" className="nav__sidebar__link" onClick={showSidebar}><span className="nav__number">01. </span>About me</a></li>
          <li><a href="#skills" className="nav__sidebar__link" onClick={showSidebar}><span className="nav__number">02. </span>Skills</a></li>
          <li><a href="#portfolio" className="nav__sidebar__link" onClick={showSidebar}><span className="nav__number" >03. </span>Portfolio</a></li>
          <li><a href="#contact" className="nav__sidebar__link" onClick={showSidebar}><span className="nav__number" >04. </span>Contact</a></li>
        </ul>
      </Sidebar>
    </>
  )
