  ...
  return (
    <>
      <section id="portfolio" className="portfolio">
        ...
        <PortfolioLeft title="Looking For You" description="This platform was designed to connect players, organizations and other specialized people from the gaming industry in a simple and effective form of registration in our database and subsequent display in our search engine." tech={["Javascript", "React", "PHP", "Laravel", "MySQL", "Aos", "Context"]} img="/img/projects/lfypicture.png" link="http://lfy.codeboot.cz" git="https://github.com/Pavelhaj93/Laravel-React-LFY-project" />
